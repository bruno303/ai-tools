...
- **`skills/rfc-implementation-plan/SKILL.md`** - turn an approved or mostly-final RFC into an implementation-ready, repository-grounded plan; hand the approved plan to `subagent-plan-execution` for execution.
